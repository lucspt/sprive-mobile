...
export default function CurrentPledge({
  navigate,
  currentEmissions,
  currentPledge,
}) {
        ...
        <>
          ...
          {currentPledge ? (
                ...
                <View style={styles.indicatorContainer}>
                  {currentEmissions > pledgeCo2e ? (
                    <Text style={styles.indicator}>
                      You've gone over by{" "}
                      {formatCO2e(currentEmissions - pledgeCo2e).join(" ")}
                    </Text>
                  ) : (
                    <Text style={styles.indicator}>
                      {formatCO2e(pledgeCo2e - currentEmissions).join(" ")}{" "}
                      until reached
                    </Text>
                  )}
                </View>
                <View style={styles.detail}>
                  ...
                  >
                    <Text style={detailStyles}>
                      {formatCO2e(pledgeCo2e).join(" ")}
                    </Text>
                    <Text style={{ fontSize: css.smallFont }}>
                      {"a ".concat(currentPledge.frequency)}
                    </Text>
                  </View>
                </View>
              </View>
            ...
            <View style={styles.setupContainer}>
              <Text style={styles.setupPledge}>
                Set up a pledge and keep track of it!
              </Text>
            </View>
          )}
        </>
